...
# Create valid characters (supports up to 100 bases)
# Entries can be multi-character strings; they are concatenated to form
# C/Cython identifiers, so only [0-9A-Za-z_] characters are used.
valid_chars = []

# Indices 0-9: single chars '0' to '9'
for i in range(48,58):
  valid_chars.append(chr(i))
# end for

# Indices 10-35: single chars 'A' to 'Z'
for i in range(65,91):
  valid_chars.append(chr(i))
# end for

# Indices 36-61: single chars 'a' to 'z'
for i in range(97,123):
  valid_chars.append(chr(i))
# end for

# Indices 62-99: two-char codes '_0'..'_9', '_A'..'_Z', '_a', '_b'
for ch in '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZab':
  valid_chars.append('_' + ch)
# end for
