...
from jetgp.full_ddegp_sparse import ddegp_utils as utils
...
class Optimizer:
    """
    Optimizer class to perform hyperparameter tuning for sparse DDEGP models
    ...
    def _sparse_nlml_direct(self, x0):
        ...
        """
        from jetgp.full_ddegp_sparse.sparse_cholesky import build_U_from_phi
    ...
    **kwargs):
        """
        Optimize the DDEGP model hyperparameters.
