...
def rbf_kernel_fast(phi_exp_3d, plan, out=None):
    ...
    out : ndarray, optional
        Pre-allocated output array of shape (total, total). If None, a new
        array is allocated. Reusing a buffer avoids repeated allocation of
        large matrices during optimization loops.
    ...
    # Use cached offsets if available, otherwise compute them
