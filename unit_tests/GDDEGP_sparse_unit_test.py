"""
Unit test for 2D Sparse Generalized Directional DEGP (GDDEGP) with gradient-aligned rays.

This test verifies that the sparse GDDEGP model correctly interpolates both function values
...
class TestSparseGDDEGPBraninGradientAligned(unittest.TestCase):
    """Test case for sparse GDDEGP on the 2D Branin function with gradient-aligned rays."""
    ...
    def setUpClass(cls):
        ...
        # --- Initialize and train sparse GDDEGP model ---
        cls.model = gddegp(
            cls.X_train,
            cls.y_train,
            n_order=cls.n_order,
    ...
    def test_function_interpolation(self):
        """Verify that the sparse GDDEGP interpolates function values."""
    ...
    def test_directional_derivative_interpolation(self):
        """Verify that the sparse GDDEGP interpolates gradient-aligned directional derivatives."""
    ...
    def test_comprehensive_summary(self):
        ...
        print("\n" + "=" * 80)
        print("Sparse GDDEGP Branin Gradient-Aligned Ray Interpolation Summary")
        print("=" * 80)
        ...
        print(f"  - Domain: x in [{self.domain_bounds[0][0]}, {self.domain_bounds[0][1]}], "
              f"y in [{self.domain_bounds[1][0]}, {self.domain_bounds[1][1]}]")
...
class TestSparseGDDEGPBraninZeroOrder(unittest.TestCase):
    """Test case for sparse GDDEGP with n_order=0 (function values only, no derivative training)."""
    ...
    def setUpClass(cls):
        ...
        # --- Initialize and train sparse GDDEGP model with n_order=0 ---
        cls.model = gddegp(
            cls.X_train,
            cls.y_train,
            n_order=cls.n_order,
    ...
    def test_function_interpolation_zero_order(self):
        """Verify that the sparse GDDEGP with n_order=0 interpolates function values."""
    ...
    def test_comprehensive_summary_zero_order(self):
        ...
        print("\n" + "=" * 80)
        print("Sparse GDDEGP Zero-Order (n_order=0) Interpolation Summary")
        print("=" * 80)
...
def run_tests_with_details():
    ...
    suite.addTests(loader.loadTestsFromTestCase(TestSparseGDDEGPBraninGradientAligned))
    suite.addTests(loader.loadTestsFromTestCase(TestSparseGDDEGPBraninZeroOrder))
...
if __name__ == "__main__":
    print("\nRunning Sparse GDDEGP Branin Gradient-Aligned Unit Tests...")
    print("=" * 80 + "\n")
