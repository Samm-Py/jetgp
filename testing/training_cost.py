...
# Configure axes
ax.set_xlabel('Training Points', fontsize=12, fontweight='bold')
ax.set_ylabel('Dimensions', fontsize=12, fontweight='bold')
ax.set_zlabel('Training Time (seconds)', fontsize=12, fontweight='bold')
...
ax1.set_title(
    f'Spatial Sparsity Speedup\n({spatial_fraction*100:.0f}% of points)', fontsize=14, fontweight='bold')
ax1.set_xlabel('Training Points', fontsize=12)
ax1.set_ylabel('Dimensions', fontsize=12)
ax1.set_zlabel('Speedup Factor', fontsize=12)
...
ax2.set_title(
    f'Derivative Sparsity Speedup\n({derivative_fraction*100:.0f}% of types)', fontsize=14, fontweight='bold')
ax2.set_xlabel('Training Points', fontsize=12)
ax2.set_ylabel('Dimensions', fontsize=12)
ax2.set_zlabel('Speedup Factor', fontsize=12)
...
ax3.set_title(
    f'Hybrid Sparsity Speedup\n({spatial_fraction*100:.0f}% × {derivative_fraction*100:.0f}%)', fontsize=14, fontweight='bold')
...
surf4c = ax4.plot_surface(
    N_mesh, D_mesh, hybrid_ratio_clipped, cmap='Purples', alpha=0.8)
ax4.set_title('All Speedup Ratios Combined', fontsize=14, fontweight='bold')
...
# ax1.set_title(
#     f'Speedup vs Training Points\n(d={fixed_d} dimensions)', fontsize=14, fontweight='bold')
# ax1.set_xscale('log')
# ax1.legend()
