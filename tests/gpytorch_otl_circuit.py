"""
Benchmark: GPyTorch DEGP on the OTL Circuit function (6D)
...
def main():
    ...
    for n_train in SAMPLE_SIZES:
        print(f"\n{'='*60}")
        print(f"  GPyTorch DEGP — OTL Circuit — n_train = {n_train}")
        print(f"{'='*60}")
    ...
    print(f"\nResults saved to results_gpytorch_{FUNCTION_NAME}.json")
