"""
Benchmark: GPyTorch DEGP on the Morris function (20D)
...
def main():
    ...
    for n_train in SAMPLE_SIZES:
        print(f"\n{'='*60}")
        print(f"  GPyTorch DEGP — Morris — n_train = {n_train}")
        print(f"{'='*60}")
    ...
    with open(f"results_gpytorch_{FUNCTION_NAME}_{N_TRAINING_ITER}iter.json", 'w') as f:
