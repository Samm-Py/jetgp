"""
Quick large-scale DEGP profile with SE isotropic kernel: n_train=200, DIM=20 → 4200×4200 kernel.
...
print(f"Building DEGP model: n_train={N_TRAIN}, DIM={DIM}, kernel={KERNEL}, type={KERNEL_TYPE}")
