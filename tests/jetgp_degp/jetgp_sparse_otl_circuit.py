"""
Benchmark: JetGP Sparse DEGP on the OTL Circuit function (6D)
...
by jetgp_otl_circuit.py and combined in a plotting script.
"""
...
def main():
    ...
    for n_train in SAMPLE_SIZES:
        print(f"\n{'='*70}")
        print(f"  OTL Circuit 6D — n_train = {n_train}")
        print(f"{'='*70}")
...
def single():
    ...
    print(f"  Sparse DEGP (rho={rho}) — OTL Circuit — n_train={n_train}, seed={seed}")
