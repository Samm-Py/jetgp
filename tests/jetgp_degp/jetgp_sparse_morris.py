"""
Benchmark: JetGP Sparse DEGP on the Morris function (20D)
...
by jetgp_morris.py and combined in a plotting script.
"""
...
def main():
    ...
    for n_train in SAMPLE_SIZES:
        print(f"\n{'='*70}")
        print(f"  Morris 20D — n_train = {n_train}")
        print(f"{'='*70}")
...
def single():
    """Run a single (rho, n_train, seed) and append to output JSON."""
    ...
    print(f"  Sparse DEGP (rho={rho}) — Morris — n_train={n_train}, seed={seed}")
