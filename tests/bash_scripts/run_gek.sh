...
TASKS=(
  "borehole:gek/gekpls_borehole_ndim.py:8:8,40,80"
  "otl_circuit:gek/gekpls_otl_circuit_ndim.py:6:6,30,60"
  "morris:gek/gekpls_morris_ndim.py:20:20,100,200"
  "active_subspace:gek/gekpls_active_subspace_ndim.py:10:10,50,100"
)
...
for ENTRY in "${TASKS[@]}"; do
  ...
  rm -f "data/results_gekpls_ndim_${FUNC}*.json"

  echo ""
  echo "============================================"
  echo "  GEKPLS — ${FUNC} (${DIM}D, ndim)"
  echo "============================================"
