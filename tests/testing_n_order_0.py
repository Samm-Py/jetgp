...
# Train with function values ONLY (n_order=0)
y = [f(X_train).reshape(-1,1)]

with warnings.catch_warnings():
    warnings.simplefilter('ignore')
    model = degp(X_train, y, n_order=0, n_bases=2,
        der_indices=None,
...
# Predict derivatives even though we trained with n_order=0
